...
namespace Hi_Shop.Persistence.Migrations
{
    ...
    [Migration("20220606054156_changesForBasket")]
    partial class changesForBasket
    {
            ...
            modelBuilder.Entity("Hi_Shop.Domain.Baskets.Basket", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2022, 6, 6, 10, 11, 55, 680, DateTimeKind.Local).AddTicks(8201));
            ...
            modelBuilder.Entity("Hi_Shop.Domain.Baskets.BasketItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 6, 10, 11, 55, 681, DateTimeKind.Local).AddTicks(213));
            ...
            modelBuilder.Entity("Hi_Shop.Domain.Catalogs.CatalogBrand", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 6, 10, 11, 55, 681, DateTimeKind.Local).AddTicks(2678));
            ...
            modelBuilder.Entity("Hi_Shop.Domain.Catalogs.CatalogItem", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 6, 10, 11, 55, 681, DateTimeKind.Local).AddTicks(4854));
            ...
            modelBuilder.Entity("Hi_Shop.Domain.Catalogs.CatalogItemFeature", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 6, 10, 11, 55, 681, DateTimeKind.Local).AddTicks(7658));
            ...
            modelBuilder.Entity("Hi_Shop.Domain.Catalogs.CatalogItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 6, 10, 11, 55, 681, DateTimeKind.Local).AddTicks(9481));
            ...
            modelBuilder.Entity("Hi_Shop.Domain.Catalogs.CatalogType", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 6, 10, 11, 55, 682, DateTimeKind.Local).AddTicks(1501));
